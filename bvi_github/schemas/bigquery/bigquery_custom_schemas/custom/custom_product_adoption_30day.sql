-- CUSTOM custom_product_adoption_30day
-- Review: 26/01/2018
...
LEFT JOIN (
  ...
  WHERE
    TRUE
    AND users_ou_list._PARTITIONTIME >= DATE_ADD(YOUR_TIMESTAMP_PARAMETER, -30, "DAY")
    AND users_ou_list._PARTITIONTIME < DATE_ADD(YOUR_TIMESTAMP_PARAMETER,1,"DAY") GROUP BY 1,2,3,4,5) users
ON
