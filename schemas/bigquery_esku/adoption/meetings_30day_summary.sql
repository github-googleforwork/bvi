...
SELECT
    ...
    SUM(num_calls_android) AS total_num_calls_android,
    SUM(num_calls_ios) AS total_num_calls_ios,
    SUM(num_calls_web) AS total_num_calls_web,
    SUM(num_calls_chromebase) AS total_num_calls_chromebase,
    SUM(num_calls_chromebox) AS total_num_calls_chromebox,
    SUM(num_calls_jamboard) AS total_num_calls_jamboard,
    SUM(num_calls_unknown_client) AS total_num_calls_unknown,
    SUM(total_call_minutes_android) AS total_call_minutes_android,
    SUM(total_call_minutes_ios) AS total_call_minutes_ios,
    SUM(total_call_minutes_web) AS total_call_minutes_web,
    SUM(total_call_minutes_chromebase) AS total_call_minutes_chromebase,
    SUM(total_call_minutes_chromebox) AS total_call_minutes_chromebox,
    SUM(total_call_minutes_jamboard) AS total_call_minutes_jamboard,
    SUM(total_call_minutes_unknown_client) AS total_call_minutes_unknown_client,
    ...
    SUM(total_call_minutes_by_internal_users) AS total_call_minutes_by_internal_users,
    SUM(total_call_minutes_by_external_users) AS total_call_minutes_by_external_users,
    SUM(total_call_minutes_by_pstn_in_users) AS total_call_minutes_by_pstn_in_users,
