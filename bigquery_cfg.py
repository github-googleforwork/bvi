...
setup['tables'] = [
    ...
    #     {
    #        'name': 'product_active_users_1day',
    #        'dataset': 'users',
    #        'description': 'Counts active users by product for each day',
    #        'timePartitioning': {
    #            'type': 'DAY',
    #        },
    #        'level': 1,
    ...
    },
    {
        'name': 'customer_usage',
        'dataset': 'raw_data',
        'description': 'Data from Customer Usage API endpoint',
        'schema': {
            'fields': [
                {
                    "mode": "NULLABLE",
    ...
    },
    {
        'name': 'user_usage',
        'dataset': 'raw_data',
        'description': 'Data from User Usage API endpoint',
        'schema': {
            'fields': [
                {
                    "mode": "NULLABLE",
    ...
    },
    {
        ...
        'dataset': 'adoption',
        'description': 'Number of calls grouped by device type calculated from past 30 days',
        'type': 'view',
    },
    {
    ...
    },
    {
        ...
        # requires YOUR_TIMESTAMP_PARAMETER to be replaced
        # before executing
        'name': 'customer_usage_date_summary',
        'dataset': 'adoption',
        'description': '',
        'timePartitioning': {
            'type': 'DAY',
    ...
    },
    {
        ...
        # requires YOUR_TIMESTAMP_PARAMETER to be replaced
        # before executing
        'name': 'customer_usage_date_summary_extended',
        'dataset': 'adoption',
        'description': '',
        'timePartitioning': {
            'type': 'DAY',
    ...
    },
    {
        ...
        'dataset': 'adoption',
        'description': '30day profiles by raw numbers and percentage for today - 3 days',
        'type': 'view',
    },
    {
        'name': 'collab_adoption_30day_latest_pie_chart',
        'dataset': 'adoption',
        'description': '30day profiles by raw numbers and percentage for today - 3 days to be used on pie charts',
        'type': 'view',
    },
    {
